    ...
    render() {
        ...
        return (
            <div className="container">
              ...
              <p className="block-hash">{block.hash} <img src="/static/img/icons/code.svg" /></p>
              <div className="prev-next-blocks-btns">
                <div>
                  <Link to={'/block/' + previousBlock}>
                    <div>
                      <div>
                        <img src="/static/img/icons/Arrow-left-blue.svg" />
                      </div>
                      <div>
                        <span>Previous</span>
                      </div>
                ...
                <div>
                  <Link to={'/block/' + nextBlock}>
                    <div>
                      ...
                      <div>
                        <img src="/static/img/icons/Arrow-r-blue.svg" />
                      </div>
                    </div>
                  </Link>
                </div>
